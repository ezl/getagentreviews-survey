...
export default {
  ...
  computed: {
    ...
    yelp () {
      return this.agent.profile.links.yelp
    },
    facebook () {
      return this.agent.profile.links.facebook
    },
    zillow () {
      return this.agent.profile.links.zillow
    },
    google () {
      return this.agent.profile.links.google
    }
  },
